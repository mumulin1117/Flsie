...
//        FDRDRIPmidnightGlow.endPoint = CGPoint(x: 0.8, y: 1)
...
//        FDRDRIPtitleGlow.font = UIFont.systemFont(ofSize: max(24, FDRDRIPwidthAura * 0.09), weight: .bold)
//        
...
//        FDRDRIPpickerShell.backgroundColor = .clear
//        
...
//        FDRDRIPfocusTopLine.backgroundColor = UIColor(red: 128/255, green: 62/255, blue: 1, alpha: 1)
//        
//        FDRDRIPfocusBottomLine.translatesAutoresizingMaskIntoConstraints = false
//        FDRDRIPfocusBottomLine.backgroundColor = UIColor(red: 128/255, green: 62/255, blue: 1, alpha: 1)
//        
...
//        
//        let FDRDRIProwGlow = max(56, FDRDRIPheightAura * 0.058)
//        NSLayoutConstraint.activate([
//            FDRDRIPbackGlow.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: FDRDRIPwidthAura * 0.05),
//            FDRDRIPbackGlow.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: FDRDRIPheightAura * 0.012),
//            FDRDRIPbackGlow.widthAnchor.constraint(equalToConstant: 28),
//            FDRDRIPbackGlow.heightAnchor.constraint(equalToConstant: 28),
//            FDRDRIPtitleGlow.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: FDRDRIPwidthAura * 0.085),
//            FDRDRIPtitleGlow.topAnchor.constraint(equalTo: FDRDRIPbackGlow.bottomAnchor, constant: FDRDRIPheightAura * 0.046),
...
//            FDRDRIPpickerShell.topAnchor.constraint(equalTo: FDRDRIPsubtitleGlow.bottomAnchor, constant: FDRDRIPheightAura * 0.055),
//            FDRDRIPpickerShell.widthAnchor.constraint(equalTo: view.widthAnchor, multiplier: 0.54),
//            FDRDRIPpickerShell.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.43),
...
//            FDRDRIPfocusTopLine.centerYAnchor.constraint(equalTo: FDRDRIPpickerShell.centerYAnchor, constant: -FDRDRIProwGlow * 0.48),
...
//            FDRDRIPfocusBottomLine.centerYAnchor.constraint(equalTo: FDRDRIPpickerShell.centerYAnchor, constant: FDRDRIProwGlow * 0.48),
...
//            FDRDRIPcontinueAura.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -FDRDRIPheightAura * 0.035),
...
//        ])
//        
//        if let FDRDRIPseedIndex = FDRDRIPyearOrbitRack.firstIndex(of: FDRDRIPyearFocusGlow) {
//            FDRDRIPyearPicker.selectRow(FDRDRIPseedIndex, inComponent: 0, animated: false)
//        }
//    }
//    
...
//        let FDRDRIPcenterAura = FDRDRIPyearOrbitRack.firstIndex(of: FDRDRIPyearFocusGlow) ?? row
...
//        case 0:
//            FDRDRIPyearLabel.font = UIFont.systemFont(ofSize: 58, weight: .heavy)
//            FDRDRIPyearLabel.textColor = .white
//            FDRDRIPyearLabel.alpha = 1
//        case 1:
//            FDRDRIPyearLabel.font = UIFont.systemFont(ofSize: 32, weight: .bold)
//            FDRDRIPyearLabel.textColor = UIColor.white.withAlphaComponent(0.52)
...
//            FDRDRIPyearLabel.alpha = 0.7
//        default:
//            FDRDRIPyearLabel.font = UIFont.systemFont(ofSize: 20, weight: .semibold)
//            FDRDRIPyearLabel.textColor = UIColor.white.withAlphaComponent(0.16)
//            FDRDRIPyearLabel.alpha = 0.42
//        }
//        
