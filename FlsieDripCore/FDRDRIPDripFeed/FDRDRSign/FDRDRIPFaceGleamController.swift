...
final class FDRDRIPFaceGleamController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate, AVCapturePhotoCaptureDelegate {
    ...
    private func FDRDRIPbuildFaceAura() {
        ...
        NSLayoutConstraint.activate([
            ...
            FDRDRIPconsentGlyph.topAnchor.constraint(equalTo: FDRDRIPresultAura.bottomAnchor, constant: FDRDRIPheightAura * 0.1),
            ...
            FDRDRIPtakeAura.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -FDRDRIPheightAura * 0.029),
