...
class FDRViralChallenge_Controller:UIViewController , WKScriptMessageHandler {
   ...
   func insertopIndcatoer()  {
    ...
    init(_odorControl: String = "",pageString:ItemPageDescString) {
    ...
    func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        if message.name == "switchFitView" {
            if let hat =  message.body as? String{
                ...
                self.navigationController?.pushViewController(FDRViralChallenge_Controller.init(_odorControl:hat, pageString: .nothing), animated: true)
            }
    ...
    override func viewDidLoad() {
        ...
        if let givingBack = localSourcing  {
            ...
            if  let url = URL(string: pageString.rootRoute(realRoo: self.odorControl) ) {
